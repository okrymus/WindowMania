...
int CFileOperate::Existence(LPCTSTR lpSource)
{
	WIN32_FIND_DATA fd;
...
BOOL CFileOperate::CdDotDot(LPTSTR lpCurDirectory)
{
...
BOOL CFileOperate::IsParentDirectory(LPCTSTR lpParent, LPCTSTR lpSubDirectory)
{
...
TCHAR CFileOperate::IsRoot(LPCTSTR lpDirectory)
{
...
// File operations
/////////////////////////////////////////////////////////////////
BOOL CFileOperate::Ren(LPCTSTR lpSource, LPCTSTR lpDestination, BOOL bHidePrompt)
{
...
BOOL CFileOperate::Del(LPCTSTR lpSource, BOOL bHidePrompt)
{
	TCHAR szSource[MAX_PATH + 2] = _T("");
	::_tcsncpy(szSource, lpSource, MAX_PATH);
...
BOOL CFileOperate::Copy(LPCTSTR lpSource, LPCTSTR lpDestination, BOOL bHidePrompt)
{
...
/////////////////////////////////////////////////////////////////
BOOL CFileOperate::XCopy(LPCTSTR lpSource, LPCTSTR lpDestination, BOOL bHidePrompt)
{
	TCHAR szSource[MAX_PATH + 2] = _T("");
	TCHAR szDestination[MAX_PATH + 2] = _T("");
	::_tcsncpy(szSource, lpSource, MAX_PATH);
...
/*
BOOL CFileOperate::DelTree(LPCTSTR lpSource, BOOL bHidePrompt)
{
	TCHAR szSource[MAX_PATH + 2] = _T("");
	::_tcsncpy(szSource, lpSource, MAX_PATH);
...
BOOL CFileOperate::Move(LPCTSTR lpSource, LPCTSTR lpDestination, BOOL bHidePrompt)
{
...
BOOL CFileOperate::MkDir(LPCTSTR lpDirectory)
{
	return ::CreateDirectory(lpDirectory, NULL);
}

BOOL CFileOperate::RmDir(LPCTSTR lpDirectory)
{
...
/////////////////////////////////////////////////////////////////
BOOL CFileOperate::SetAttribute(LPCTSTR lpSource, DWORD dwNewAttr)
{
	return ::SetFileAttributes(lpSource, dwNewAttr);
}

DWORD CFileOperate::GetAttribute(LPCTSTR lpSource)
{

...
void CSplashWindow::GetVersionStrings()
{
	...
	m_productNameString = (CString)"Operating System";
	m_companyNameString = (CString)"CIT @ BHCC";
	m_copyrightString = (CString)"copyright (R) 2017";
	m_commentsString = (CString)"written by Panupong Lee";
	m_versionString = (CString)"version: 1.0.0.0";
}
...
const int CSplashWindow::m_productNameVerticalOffset = 190;		// empty space between top border and Product Name
...
COLORREF CSplashWindow::m_productNameTextColor = RGB(255, 255, 255);// color used for text
...
const int CSplashWindow::m_bodyLeftMargin = 20;				// distance from left side to place company name, copyright, version and comment
